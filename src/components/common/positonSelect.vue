...
<template>
	<span class="positonSelect">
		...
		<div class="selectPanel" v-if="is_show">
			<div class="filter">
				<span @click="showCitySelect">选择城市ｖ</span>
				<input @focus="" class="mgl10" placeholder="您要去哪儿" type="" name="">
				<span class="fr fontGrey">取消</span>
			</div>
			<div class="body">
				...
				<div class="positionSelect" v-if="isPositionSelectShow">
...
export default {
	...
	methods:{
		...
		goAnchor(selector) {
	        ...
	        this.$el.querySelector(".citySelect").style="transform: translate(0px, -"+anchor.offsetTop+"px) translateZ(0px)";
	    }
	}
